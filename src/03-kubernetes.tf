module "aws_ecr_repository" {
  source = "git::https://github.com/bradmccoydev/terraform-modules.git//aws/aws_ecr_repository?ref=tags/v0.1.0"
  name   = local.shared_name
  tags   = merge(local.tags, var.cloud_custom_tags)
}

module "aws_eks_cluster" {
  source                 = "git::https://github.com/bradmccoydev/terraform-modules//aws/aws_eks_cluster?ref=tags/v0.1.0"
...
module "aws_eks_node_group" {
  source               = "git::https://github.com/bradmccoydev/terraform-modules//aws/aws_eks_node_group?ref=tags/v0.1.0"
...
module "aws_secretsmanager_secret" {
  source        = "git::https://github.com/bradmccoydev/terraform-modules//aws/aws_secretsmanager_secret?ref=tags/v0.1.0"
